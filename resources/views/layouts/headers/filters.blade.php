                            ...
                            <div class="col-6 col-lg-8 ">
                                <div class="form-group mt--2 mb--2">
                                    <input name="q" type="text" value="{{ request()->get('q') }}"
                                        placeholder="{{ __('Search for restaurant, cuisines, and dishes') }}"
                                        class="success form-control form-control-alternative is-valid">
                                    <input name="location" value="{{ request()->get('location') }}" type="hidden" />
                                </div>
                            </div>
                            <div class="col-3 col-lg-3 ">
                                <a onclick="document.getElementById('theQuryForm').submit();" type="submit"
                                    href="javascript:;"><span class="search">
                                        {{ __('Search') }}
                                    </span></a>
                            </div>
